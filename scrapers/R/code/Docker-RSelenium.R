# Some websites are not easily scrape-able using the simple read_html() function. 
# Websites might have dynamically-loaded pages that are difficult to navigate through, 
# or some content might be loaded with Javascript that must be rendered in a browser window.

# To scrape these sites, we use the RSelenium package and Docker tool. See the readme for more details. 
